...
function animateListItems2() {
	...
	if (
		...
		tla.fromTo(
			...
			{opacity: 0, x: -20},
			{opacity: 1, x: 0, duration: 1, ease: "ease-in", delay: 0.5},
			"0"
		);
		tla.fromTo(
		...
		tla.to({}, {duration: 2.5}); // Пауза на 2 секунды
...
function animateEdelhaus2() {
	...
	const footer = document.querySelector(
		".block-anim-edelhaus-2__footer .text-top"
	);
	const textTransform = document.querySelector(
		".block-anim-edelhaus-2__footer .text-transform"
	);
